...
<table style="width:600px"><thead><tr class="tableizer-firstrow"></tr></thead><tbody><tr><th  colspan="2" style=background:PaleTurquoise>3.3.2.5 发送数据6字节，返回数据2字节</th></tr><tr><td style="width:150px">命令名称</td><td>读取命令</td></tr><tr><td>说明</td><td>此命令类发送数据长度为6，返回数据长度为2。</td></tr><tr><td>指令符</td><td><a href="#!pages/CAN_Communication_Protocol.md#写入指令3:">见写入指令5</a></td></tr><tr><td>数据长度</td><td>6</td></tr><tr><td>数据内容</td><td>无</td></tr><tr><td>指令符（返回值）</td><td><a href="#!pages/CAN_Communication_Protocol.md#写入指令5:">见写入指令5</a></td></tr><tr><td>数据长度 (返回值)</td><td>2</td></tr><tr><td>执行器返回数据</td><td>无</td></tr></tbody></table>
