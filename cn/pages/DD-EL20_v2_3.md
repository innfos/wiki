...
<table class="tableizer-table" style="width:1000px">
<thead><tr class="tableizer-firstrow"><th colspan="1" style="background: PaleTurquoise; color: black;width:800px">注：编码器：多圈绝对式编码器（±127圈）;电机保护温度可设置范围:25~120 °C;逆变器保护温度可设置范围:25~120 °C
</td></tr></tbody></table>
