...
<img src="../img/六轴谐波版协作机械臂_v1_0.png" style="width:720px">                                                                          

## 六轴谐波版协作机械臂工程参数图
<br>[单位：毫米]

<img src="../img/ 6轴谐波版协作机械臂_v1_0.md三视图.png" style="width:720px">


### 3D 模型
[模型文件]( ../img/6轴谐波版协作机械臂_v1_0.step.zip )


## 六轴谐波版协作机械臂参数

<table style="width:500px"><thead><tr><th colspan="2" style="background: PaleTurquoise; color: black;">六轴谐波版协作机械臂参数</th></tr></thead><tbody></tr><tr><td>末端负载</td><td>6kg</td></tr>
...
<table style="width:400px"><thead><tr style="background:PaleTurquoise"><th style="width:100px">版本号</th><th style="width:150px">更新时间</th><th style="width:150px">更新内容</th></tr></thead><tbody><tr><td>v1.0.0</td><td>2019.09.10</td><td>全文添加</td></tbody></table>
