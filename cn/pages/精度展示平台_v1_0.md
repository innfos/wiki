...
<br>精度展示平台中在 SCA 的帮助下实现了高速运动中的多轴精确控制，SCA 有充 沛的动力性能以及出色的柔性控制能力，其娇小的身材在高精度应用场景中会 有更出众的表现。

参考 SCA 型号:[DD-NE30](DD-NE30_v2_2.md)    [DD-EL20](pages/DD-EL20_v2_3.md)

                                                                          
<img src="../img/精度展示平台_v1_0.png" style="width:720px">                                                                          

## 工程参数图
<br>[单位：毫米]

<img src="../img/精度展示平台_v1_0.md三视图.png" style="width:720px">


### 3D模型
[模型文件]( ../img/精度展示平台_v1_0.step.zip )


## 基本参数

<table style="width:500px"><thead><tr><th colspan="2" style="background: PaleTurquoise; color: black;">精度展示平台参数</th></tr></thead><tbody></tr><tr><td>末端负载</td><td>500g</td></tr>
