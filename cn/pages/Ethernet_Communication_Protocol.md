...
#### 读取指令4:
<table style="width:700px"><thead><tr class="tableizer-firstrow"></tr></thead><tbody> <tr><td colspan="3"style=background:PaleTurquoise>A.1.4 读取指令4</td></tr><tr><td style="width:100px">指令符</td><td style="width:200px">定义</td><td>说明</td></tr><tr><td>0x94</td><td>执行器电流速度位置</td><td>读取指定ID执行器的电流速度位置。前3字节表示位置值,中间2字节表示速度值,最后2字节表示电流值,数值为真实值的2^24倍.</td></tr></tbody></table>
