...
数据06为梯形位置模式（参见[模式表](#!pages/Ethernet_Communication_Protocol.md#模式表 "wikilink")），3F 42为[CRC校验码]((#!pages/Ethernet_Communication_Protocol.md#CRC校验码计算方法 "wikilink")，激活成功后会收到返回：
