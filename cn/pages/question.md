...
**如何在速度和电流模式下也能实现位置限位功能？**

* 激活 Homing Mode，选择Limit选项，勾选上以后保存参数就可以在速度或者电流模式实现位置限位功能。
...
**对于电机标签编号MINTASCA_016：出现在电流环中，设置相同的Iq值，此电机的转速与其他电机差异很大?**
...
*   执行报错以后，上位机软件会提示故障代码，可以在主页下`MINTASCA CAN通信协议`的最下面，报警指令表查看故障代码具体含义。
